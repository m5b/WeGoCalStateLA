...
const styles = StyleSheet.create({
  ...
  heroTitle: {
    ...
    marginBottom: width < 640 ? 20 : width < 1024 ? 24 : 32,
    letterSpacing: -1.5,
    lineHeight: width < 640 ? 40 : width < 1024 ? 50 : 64,
  },
  heroSubtitle: {
  ...
  sectionHeader: {
    alignItems: 'center',
    marginBottom: width < 640 ? 60 : 80,
  },
  sectionTitle: {
    fontSize: width < 640 ? 32 : width < 1024 ? 40 : 48,
    fontWeight: '800',
    color: Colors.PRIMARY,
    marginBottom: 24,
    textAlign: 'center',
    letterSpacing: -1,
    lineHeight: width < 640 ? 40 : width < 1024 ? 48 : 56,
  },
  sectionDescription: {
  ...
  modernQuizCard: {
    ...
    width: width < 640 ? '100%' : width < 1024 ? '48%' : '45%',
    minWidth: width < 640 ? 0 : 320,
