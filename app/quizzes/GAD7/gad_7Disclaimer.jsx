      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.contentPadding}>
          <View style={styles.disclaimerCard}>
            <AlertCircle size={40} color={Colors.WARNING} style={styles.disclaimerIcon} />
            <Text style={styles.disclaimerTitle}>Before You Begin</Text>
            
            <Text style={styles.disclaimerText}>
              The GAD-7 (Generalized Anxiety Disorder-7) is a screening tool for anxiety. Please note:
            </Text>
          ...
          <TouchableOpacity 
            ...
            onPress={() => router.push('/quizzes/GAD7/gad_7Questions')}
          >
            <LinearGradient
              colors={[Colors.PRIMARY, Colors.DARK_BLUE]}
